$(document).ready(function(){
	...
	$('#clock').countdown('2020/10/10').on('update.countdown', function(event) {
	  var $this = $(this).html(event.strftime(''
	    + '<div class="clock-item"><p>%-d</p><p>day%!d</p></div>'
	    + '<div class="clock-item"><p>%H</p><p>hours </p></div>'
	    + '<div class="clock-item"><p>%M</p><p>minutes</p></div>'
	    + '<div class="clock-item"><p>%S</p><p>seconds</p></div>'));
	});
